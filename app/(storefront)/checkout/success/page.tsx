      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 sm:p-12 shadow-sm text-center space-y-8">
        ...
        <div className="text-left bg-slate-50 rounded-xl border border-slate-200 p-6 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-4 border-b border-slate-200">
            <div>
              <span className="text-xs text-slate-400 font-mono uppercase block">Order Identifier</span>
              <strong className="text-lg font-mono font-bold text-slate-900">{order.orderNumber}</strong>
            </div>
            <div className="sm:text-right">
              <span className="text-xs text-slate-400 font-mono uppercase block">Order Status</span>
                ...
                <div key={item.id} className="py-2.5 flex justify-between text-xs">
                  <div>
                    ...
                    <span className="text-slate-500 font-mono text-[11px]">
                      Qty: {item.quantity} × {formatUSD(item.price)}
                    </span>
                  </div>
